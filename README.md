...
-   **Theme-Adaptive Controls:** New glassmorphism header and neon-accented input controls that adapt dynamically to the selected theme (Blue/Gray for Light, Neon Green for Terminal, Red/Green for Palestine).
